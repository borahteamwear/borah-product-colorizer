...
use TBProductColorizerTM\Utils\Exceptions\CacheException;
...
class Cache
{
     ...
     */
    public function __construct($cacheDir = null, $lifetime = null, $cacheExtension = null)
    {
        // Set lifetime
    ...
    public function save($cacheFileName, $value)
    {
        ...
        {
            throw new CacheException('Can\'t delete existing cache file: ' . $cacheFile);
        }
    ...
    public function isValid($cacheFileName, $deleteFileIfInvalid = false, $lifetime = null)
    {
        ...
        if (time() - filemtime($cacheFile) >= $lifetime)
        {
            ...
            {
                throw new CacheException('Attempting to delete invalid cache file has failed : ' . $cacheFile);
            }
    ...
    public function delete($cacheFileName)
    {
        ...
        {
            throw new CacheException(sprintf('Couldn\'t delete cache: %s. Full Path: %s', $cacheFileName, $cacheFile));
        }
